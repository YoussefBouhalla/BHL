...
export const aboutContent = {
  ...
  introduction:
    "I’m Youssef Bouhalla, a full-stack JavaScript and TypeScript developer focused on web products with real users, real data and real operational constraints.",
  paragraphs: [
